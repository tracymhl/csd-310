...
#displaying the main menu to the user and prompting the user to make a selection
def show_menu():
    print("\n  -- Main Menu --")
...
#lists the user's books by using an inner join query
...
#shows the different store locations
...
#lets the user see a list of books not currently in their wishlist
...
#lets the user add books to their wishlist
